              ...
              <div className="comment__list mt-5">
                ...
                <div className="single__comment d-flex gap-3">
                  ...
                  <div className="comment__content">
                    <h6 className=" fw-bold">Maria carey</h6>
                    <p className="section__description mb-0">14 July, 2022</p>
                    <p className="section__description">
                    Golden Sands hotel exceeded my expectations with their exceptional service and amenities. 
                    From the friendly staff to the luxurious rooms, everything was perfect. 
                    I highly recommend this hotel to anyone looking for a truly unforgettable stay in Morocco.
                    </p>
